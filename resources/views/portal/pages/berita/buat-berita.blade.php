...
<div class="row">
    <div class="col-md-12">
        <a href="{{url('portal/berita')}}" class="btn btn-primary mb-4"><i class="fa fa-arrow-left mr-2"></i>Daftar Berita</a>
    </div>
</div>
                        ...
                        <div class="card-body">
                            <div class="form-row">
                                ...
                                <div class="col-12 mb-4">
                                    ...
                                    <img id="featured_image" class="w-100 mb-2" src="{{ $news->featured_image ?? asset('assets_portal/assets/images/no-image.png') }}" alt="gambar-depan" />
