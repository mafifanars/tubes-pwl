...
<div class="row">
    <div class="col-md-12">
        <a href="{{ url('portal/event') }}" class="btn btn-primary mb-4"><i class="fa fa-arrow-left mr-2"></i>Daftar Event</a>
    </div>
</div>
                        ...
                        <div class="card-body">
                            <div class="form-row">
                                <div class="col-12 mb-4">
                                    ...
                                    <img id="poster" class="w-100 mb-2" src="{{ $event->poster_url ?? asset('assets_portal/assets/images/no-image.png') }}" alt="gambar-depan" />
